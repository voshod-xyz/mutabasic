...
Лицензия пока не определена. Перед публичным распространением добавьте выбранный файл `LICENSE`. Этот README не предоставляет отдельного лицензионного разрешения.
